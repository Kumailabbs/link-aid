    ...
    <div className="relative">
      ...
      >
        ...
        <span className="block mr-1 font-medium text-theme-sm">
          ...
          {userData?.fname && !userData?.lname
            ? userData?.fname
            : userData?.fname + " " + userData?.lname || "Unknown"}
        </span>
        <svg
      ...
      >
        <div>
          ...
          <span className="mt-1 inline-block text-xs rounded bg-blue-100 text-blue-700 px-2 py-0.5 dark:bg-blue-900 dark:text-blue-200">
